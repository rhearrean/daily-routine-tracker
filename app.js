const APP_META={version:"10.8.4",build:"2026.07.04.smart-time-block-focus",schemaVersion:6,releaseDate:"June 28, 2026",releaseNotes:["Added Smart Time Block Focus.","Anytime and the current block stay open; unfinished previous blocks stay open; completed and future blocks collapse.","No storage, import/export, habit, or history changes."]};
...
function shouldCollapseBlock(block,blockComplete){if(block.id==="anytime")return false;if(isCurrentTimedBlock(block))return false;if(isPastTimedBlock(block)&&!blockComplete)return false;return true}
