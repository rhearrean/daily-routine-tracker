const APP_META={version:"10.9.4",build:"2026.08.06.compact-habit-rows",schemaVersion:7,releaseDate:"August 6, 2026",releaseNotes:["Simplified habit rows in Settings.","Time-block summaries are shorter and easier to scan.","Snoozed habits now show a compact pause icon beside the name.","Detailed snooze dates and Routine Step counts remain available inside Edit."]};
