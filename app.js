const APP_META={version:"10.9.0",build:"2026.08.03.one-tap-skip",schemaVersion:7,releaseDate:"August 3, 2026",releaseNotes:["Added a visible Skip button to unresolved habits.","Removed long-press and right-click habit action menus.","Habit cards still toggle complete/clear with one tap.","Routine Steps behavior remains unchanged."]};
