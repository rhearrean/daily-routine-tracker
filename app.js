const APP_META={version:"10.9.5",build:"2026.08.07.settings-habit-layout-fix",schemaVersion:7,releaseDate:"August 7, 2026",releaseNotes:["Fixed Settings habit-row formatting on iPhone.","Habit names now display fully instead of being truncated.","Action controls use a narrower layout so habit details have more room.","No habit, snooze, reorder, or time-block behavior changes."]};
