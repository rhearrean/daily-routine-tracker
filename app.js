const APP_META={version:"10.9.6",build:"2026.08.07.snooze-icon-cleanup",schemaVersion:7,releaseDate:"August 7, 2026",releaseNotes:["Removed the duplicate small snooze icon from Settings habit rows.","Kept the existing snooze indicator unchanged.","No behavior or layout changes beyond this cleanup."]};
