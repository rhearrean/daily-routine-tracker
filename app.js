const APP_META={version:"10.8.9",build:"2026.07.29.skip-review",schemaVersion:7,releaseDate:"July 29, 2026",releaseNotes:["Added a Skipped Today review card below the date.","Skipped and missed-cutoff habits are grouped by time block.","Removed the old Today progress percentage card.","Removed unnecessary On time and Tap complete labels."]};
