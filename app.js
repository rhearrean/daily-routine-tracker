const APP_META={version:"11.1.1",build:"2026.08.22.scrollable-update-screen",schemaVersion:7,releaseDate:"August 22, 2026",releaseNotes:["Makes the update screen scrollable on smaller iPhone screens.","Keeps the backup and update controls reachable when release information is longer.","No habit, history, settings, or data-schema changes."]};
